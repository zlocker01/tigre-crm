...
export const metadata: Metadata = {
  ...
  description:
    'Política de uso y privacidad de Brotherhood 33 AV: condiciones de uso, tratamiento de datos y seguridad.',
  alternates: {
        ...
        <div className="space-y-8">
          <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
            ...
            <p className="text-gray-700">
              Bienvenido a{' '}
              <span className="font-semibold">Brotherhood 33 AV App</span>. Al
              utilizar nuestra aplicación, aceptas cumplir con los términos y
          ...
          <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1">
              ...
              <li>
                No está permitido el uso de la app para fines ilegales o no
                autorizados.
              </li>
              <li>
          ...
          <div className="bg-blue-50 rounded-lg p-6 border border-blue-100">
            ...
            <p className="text-gray-700">
              Recopilamos y tratamos datos personales de acuerdo con la
              normativa vigente y únicamente para fines relacionados con la
